...
mock
  .onGet('http://www.omdbapi.com', { params: { i: 'tt3896198', apiKey: `${process.env.API_KEY_VALUE}`}})
  .replyOnce(withMovie(0))
	.onGet('http://www.omdbapi.com/', { params: { i: 'tt3896198', apiKey: `${process.env.API_KEY_VALUE}` }})
  .replyOnce(withMovie(0))
  .onGet(`http://www.omdbapi.com/?i=tt3896198&apikey=${process.env.API_KEY_VALUE}`)
  .replyOnce(withMovie(0))
  .onGet(`http://www.omdbapi.com/?apikey=${process.env.API_KEY_VALUE}&i=tt3896198`)
  .replyOnce(withMovie(0))
  .onGet('http://www.omdbapi.com', { params: { t: 'baby driver', apiKey: `${process.env.API_KEY_VALUE}` }})
  .replyOnce(withMovie(1))
  .onGet('http://www.omdbapi.com/', { params: { t: 'baby driver', apiKey: `${process.env.API_KEY_VALUE}` }})
  .replyOnce(withMovie(1))
  .onGet(`http://www.omdbapi.com/?t=baby%20driver&apikey=${process.env.API_KEY_VALUE}`)
  .replyOnce(withMovie(1))
  .onGet(`http://www.omdbapi.com/?apikey=${process.env.API_KEY_VALUE}&t=baby%20driver`)
  .replyOnce(withMovie(1))
